...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--train', default=0)
        self.parser.add_argument('--test', action='store_true')
        self.parser.add_argument('--nepoch', type=int, default=50)
        self.parser.add_argument('--batch_size', type=int, default=1, help='can be changed depending on your machine')
        ...
        self.parser.add_argument('--previous_dir', type=str, default='/home/zlt/Documents/SGraFormer-master/checkpoint/epoch_50.pth')
