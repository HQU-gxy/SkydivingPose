...
POSE_CKPT = Path("checkpoint/dwpose/{}.pth".format(POSE_CONFIG))
...
def gen_frame_kpts(frame, people_sort, bboxs_pre, person_scores_pre, num_peroson=1, gen_output=False):
...
def gen_video_kpts(video, num_peroson=1, gen_output=False):
